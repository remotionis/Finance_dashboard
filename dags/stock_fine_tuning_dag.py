...
dag = DAG(
    dag_id='stock_fine_tuning_papermill',
...
run_notebook = PapermillOperator(
    ...
    input_nb="/home/airflow/gcs/data/notebooks/in/Stock_fine_tuning.ipynb",
    output_nb="/home/airflow/gcs/data/notebooks/out/Stock-fine-tuning-{{ ds_nodash }}.ipynb",
    parameters={
