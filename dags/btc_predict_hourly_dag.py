...
def decide_branch(**kwargs):
    ...
    if 1 <= hour <= 12:
        return "run_btc_predict_notebook"
    else:
        return "skip_task"

with DAG(
    dag_id='btc_predict_hourly_papermill',
    ...
    run_notebook = PapermillOperator(
        task_id="run_btc_predict_notebook",
        input_nb="/home/airflow/gcs/data/notebooks/in/Btc_predict_hourly_from_rds_minute.ipynb",
        output_nb="/home/airflow/gcs/data/notebooks/out/Btc-predict_hour-{{ ds_nodash }}.ipynb",
        parameters={
